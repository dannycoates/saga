import { range, randomInt, limitNumber } from './utils.js';
...
class WorldController extends EventTarget {
...
function createWorldCreator() {
  return new WorldCreator();
}

function createWorldController(dtMax) {
  return new WorldController(dtMax);
}

export { createWorldController, createWorldCreator };