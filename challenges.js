...
var challenges = [
    ...
    ,{options: {floorCount: 5, elevatorCount: 1, spawnRate: 0.4}, condition: requireUserCountWithinTime(18, 60)}
    ...
    ,{options: {floorCount: 13, elevatorCount: 2, spawnRate: 1.1, elevatorCapacities: [8,10]}, condition: requireUserCountWithinTime(50, 70)}
    ...
    ,{options: {floorCount: 9, elevatorCount: 6, spawnRate: 1.1, elevatorCapacities: [4]}, condition: requireUserCountWithMaxWaitTime(100, 16)}
    ,{options: {floorCount: 9, elevatorCount: 6, spawnRate: 1.0, elevatorCapacities: [5]}, condition: requireUserCountWithMaxWaitTime(110, 15)}
    ,{options: {floorCount: 8, elevatorCount: 6, spawnRate: 0.9}, condition: requireUserCountWithMaxWaitTime(120, 15)}
