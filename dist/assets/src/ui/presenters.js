...
function presentStats(parentElem, world) {
...
function presentFeedback(parentElem, title, message, url) {
  // Clear existing content
  parentElem.innerHTML = "";
...
function presentWorld(worldElem, world) {
  // Clear existing content
  worldElem.innerHTML = "";
...
export { presentChallenge, presentCodeStatus, presentFeedback, presentStats, presentWorld };