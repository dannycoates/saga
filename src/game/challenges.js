export const requirePassengerCountWithinTime = function(passengerCount, timeLimit) {
  return {
    ...
    evaluate: function(world) {
      if (world.elapsedTime >= timeLimit || world.transportedCounter >= passengerCount) {
        return world.elapsedTime <= timeLimit && world.transportedCounter >= passengerCount;
      } else {
        return null;
      }
    }
...
export const requirePassengerCountWithMaxWaitTime = function(passengerCount, maxWaitTime) {
  return {
    ...
    evaluate: function(world) {
      if (world.maxWaitTime >= maxWaitTime || world.transportedCounter >= passengerCount) {
        return world.maxWaitTime <= maxWaitTime && world.transportedCounter >= passengerCount;
      } else {
        return null;
      }
    }
...
export const requirePassengerCountWithinTimeWithMaxWaitTime = function(passengerCount, timeLimit, maxWaitTime) {
  return {
    ...
    evaluate: function(world) {
      if (world.elapsedTime >= timeLimit || world.maxWaitTime >= maxWaitTime || world.transportedCounter >= passengerCount) {
        return world.elapsedTime <= timeLimit && world.maxWaitTime <= maxWaitTime && world.transportedCounter >= passengerCount;
      } else {
        return null;
      }
    }
...
export const requirePassengerCountWithinMoves = function(passengerCount, moveLimit) {
  return {
    ...
    evaluate: function(world) {
      if (world.moveCount >= moveLimit || world.transportedCounter >= passengerCount) {
        return world.moveCount <= moveLimit && world.transportedCounter >= passengerCount;
      } else {
        return null;
      }
    }
...
export const challenges = [
  ...
  },
  {
    ...
    condition: requirePassengerCountWithinTime(28, 60)
  },
  {
  ...
  {
    options: { floorCount: 13, elevatorCount: 2, spawnRate: 1.1, elevatorCapacities: [8, 10] },
  ...
  {
    options: { floorCount: 9, elevatorCount: 6, spawnRate: 1.1, elevatorCapacities: [4] },
    condition: requirePassengerCountWithMaxWaitTime(100, 16)
  },
  {
    options: { floorCount: 9, elevatorCount: 6, spawnRate: 1.0, elevatorCapacities: [5] },
