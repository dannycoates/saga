...
export class JavaRuntime extends JVMRuntime {
  constructor() {
  ...
  async compileLanguageSpecific() {
    // Compile the Java base classes
    await this.compileJavaBaseClasses();
  }
  ...
  async compileJavaBaseClasses() {
    // Compile Elevator and Floor classes
